  ...
  return (
    <div className="mt-8 px-4">
             ...
             >
                ...
                <div className="flex justify-between items-start">
                   <div>
                      ...
                      <p className="text-[10px] text-gray-400 mt-0.5">{pkg.duration} tháng</p>
                   </div>
                   <div className="text-right">
                      <p className="text-[#FF6B00] font-black text-sm">{pkg.price.toLocaleString()}đ</p>
                   </div>
                </div>
                {pkg.description && <p className="text-[9px] text-gray-400 mt-2 line-clamp-1">{pkg.description}</p>}
       ...
       <PaymentModal 
          ...
          type="gym"
          packages={filteredPackages} // Pass filtered list logic handled in modal or specific selection
          selectedPackageInit={selectedPackage} // Pass specific selection
          vouchers={vouchers}
          user={user}
