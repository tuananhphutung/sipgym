...
const Home: React.FC<HomeProps> = ({ 
  user, promotions, trainers, programs, packages, ptPackages, vouchers, heroImage,
  ...
  return (
    <div className="animate-in fade-in duration-500 relative pb-10">
      ...
      <div className="px-6 mt-4">
         <button 
           onClick={handleShare}
           className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-4 rounded-2xl shadow-lg shadow-blue-100 flex items-center justify-between group active:scale-95 transition-all"
         >
      ...
      {promotions.length > 0 && (
        <div className="px-5 mt-6 overflow-x-auto no-scrollbar flex gap-4 pb-2">
           {promotions.map(promo => (
             <div key={promo.id} className="min-w-[280px] h-32 bg-orange-600 rounded-[32px] relative overflow-hidden shadow-lg shadow-orange-100 shrink-0">
      ...
      <div className="px-6 mt-8 flex justify-center">
         <button 
           ...
           className="bg-gray-100 text-gray-400 p-2 rounded-full flex items-center gap-2 hover:bg-gray-200 hover:text-gray-600 transition-colors"
           title="Admin Login"
         >
